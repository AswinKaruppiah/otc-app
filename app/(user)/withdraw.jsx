    ...
    <View className="w-full pb-8">
      ...
      <View className="items-center mb-6">
        ...
        <Text className="text-[14px] text-gray-400 font-noir text-center max-w-[280px] leading-[20px]">
          Transfer funds safely from your wallet back to your linked bank
          account.
        </Text>
      </View>
      ...
      <View className="w-full bg-noirCard rounded-2xl p-4 border border-white/[0.04] flex-row justify-between items-center mb-6">
        <Text className="text-gray-400 font-noir text-[14px] ">Available Balance</Text>
      ...
      <View className="w-full bg-noirMint/5 rounded-3xl p-6 border border-noirMint/15 items-center mb-6">
        <Text className="text-noirCyan font-noir text-[13px] uppercase tracking-[1px] mb-3">
          Enter Amount
        </Text>
        <View className="flex-row items-center justify-center mb-4">
          <Text className="text-noirText font-noir text-[32px] mr-1">$</Text>
          <TextInput
            placeholder="0.00"
            ...
            className="text-noirText font-noir text-[40px] text-center min-w-[120px] max-w-[220px]"
          />
        </View>
        ...
        <View className="flex-row gap-2.5">
          {[0.25, 0.5, 1.0].map((val, idx) => (
            ...
            >
              <Text className="text-noirText font-noir text-[12px] ">
                {val === 1.0 ? "MAX" : `${val * 100}%`}
              </Text>
            </TouchableOpacity>
          ))}
      ...
      <View className="flex-row gap-3 mb-8">
        ...
        >
          <Feather
            name="clock"
            size={20}
            color={!isInstant ? "#baffd8" : "rgba(255, 255, 255, 0.45)"}
            className="mb-2"
          />
          <Text className="text-noirText font-noir text-[14px] mb-0.5">Standard</Text>
          <Text className="text-gray-400 font-noir text-[11px] ">
        ...
        >
          <Feather
            name="zap"
            size={20}
            color={isInstant ? "#96dded" : "rgba(255, 255, 255, 0.45)"}
            className="mb-2"
          />
          <Text className="text-noirText font-noir text-[14px] mb-0.5">Instant</Text>
          <Text className="text-gray-400 font-noir text-[11px] ">
            $1.50 Fee • In minutes
          </Text>
        </TouchableOpacity>
      ...
      <View className="w-full gap-3">
        ...
        >
          ...
          <Text className="text-noirBg font-noir text-[15px] ">Confirm Withdrawal</Text>
        </TouchableOpacity>
        ...
        >
          <Text className="text-noirText font-noir text-[15px] ">Cancel</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
