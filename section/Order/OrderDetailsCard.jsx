            ...
            <Show.If isTrue={!!(inrAmount || usdtAmount || exchangeRate)}>
                <View className="w-full">
                    ...
                    >
                            ...
                            >
                                <View className="flex-row items-center justify-between">
                                    ...
                                    <View className="bg-white/[0.06] px-2.5 py-1 rounded-full border border-white/[0.06]">
                                        <Text className="text-gray-500 font-noir-medium text-[10px] uppercase tracking-wider">
                                            You Pay
                                        </Text>
                                    </View>
                                </View>
                                ...
                                <View className="mt-5 mb-1">
                                    <Text className="text-white/90 font-noir text-[44px] leading-none">
                        ...
                        {/* Exchange Rate Badge — floats over the divider */}
                        <View
